...
1. Sidecar Proxy (Plano de datos / Data Plane), cada microservicio tiene asociado un Proxy (Envoy, es un proxy de código abierto) que corre como un contenedor adicional en el mismo contenedor, a este patrón se le llama _Sidecar_
	...
	- Todo el tráfico que entra y sale a través de ese proxy, no directamente al servicio.
...
## Gobierno de TI
Gobierno de Tecnologías de la Información se refiere a un marco o marcos, que gestionan cómo las organizaciones optimizan el uso de la operaciones de TI para apoyar los objetivos empresariales. _No se trata solo de tecnología, sino de cómo las decisiones sobre TI se alinean con el negocio_

**Objetivos del Gobierno de TI**
1. Alineación estratégica entre TI y el negocio 
2. Entrega de valor a través de servicios tecnológicos eficientes. 
3. Gestión de riesgos de TI (seguridad, disponibilidad, cumplimiento legal)
4. Uso adecuado de recursos de TI (presupuesto, infraestructura, personal)
5. Medición del desempeño de TI con indicadores (KPI, métricas)

Organizaciones de normalización del gobierno de TI
1. ISACA(creo COBIT): es una organización que proporciona credenciales a los profesionales de TI en áreas clave de auditoría, ciberseguridad y más.
2. Organización Internacional de Normalización: esta organización no gubernamental elabora normas para todas la unidades empresariales, incluidas las operaciones de TI, con el fin de facilitar el comercio y la cooperación. 
3. Axelos(creo ITIL): es responsable de varias certificaciones, incluida la biblioteca de infraestructura de TI (ITIL). 

**_Control de TI_** 
Se refiere a las medidas y procedimientos implementados para garantizar que los sistemas informáticos funcionen correctamente, de manera segura, confiables y conforme a las políticas.
_Es como el día a día del Gobierno de TI_.

**Objetivos del Control de TI**
1. Proteger la información (confidencialidad, integridad y disponibilidad)
2. Evitar fraudes y errores
3. Asegurar el cumplimiento con normativas legales (como protección de datos)
4. Mantener la operación continua de los sistemas 

**Relación entre Gobierno y Control de TI**

| Gobierno de TI                   | Control de TI                            |
| -------------------------------- | ---------------------------------------- |
| Estrategia y supervición         | Implementación práctica                  |
| Toma de decisiones               | Ejecución de procesos                    |
| Define el "qué" y "por qué"      | Ejecuta el "cómo"                        |
| Usa marcos como COBIT, ITIL, ISO | Aplica controles internos y de seguridad |

# Exposiciones

## Gestión de TI
Es el conjunto de procesos, actividades, herramientas y recursos que permiten planificar, implementar, operar, supervisar y mejorar los servicios, sistemas y recursos tecnológicos de una organización. 

_**Objetivo**, asegurar que TI funcione de manera eficiente y efectiva para cumplir con los objetivos operativos del negocio (día a día), maximizando valor y reduciendo riesgos y costos_

**_Áreas Claves de la Gestión de TI_**
1. Gestión de servicios (ITSM), asegura que los servicios de TI se entreguen con calidad y según lo acordado (ITIL)
2. Gestión de infraestructura, controla hardware, redes, centros de datos, toda la infraestructura
3. Gestión de aplicaciones, desarrollo, mantenimiento y operación de software interno y externo
4. Gestión de proyectos, planifica y ejecuta proyectos de TI dentro del tiempo, alcance y costo 
5. Gestión de recursos humanos en TI, selección, capacitación y organización del personal de TI
6. Gestión financiera de TI, presupuestos, costos, ROI (retorno de inversión), eficiencia económica
7. Gestión de seguridad y riesgos, políticas y controles para proteger datos, sistemas y continuidad del negocio

## Gobierno y Gestión de TI

#### Diferencia entre Gobierno de TI y Gestión de TI

| Característica        | Gobierno de TI                                                      | Gestión de TI                                        |
| --------------------- | ------------------------------------------------------------------- | ---------------------------------------------------- |
| **Enfoque principal** | Estrategia, dirección, alineación con el negocio                    | Ejecución, operación, implementación                 |
| **¿Qué hace?**        | Decide qué hacer con TI                                             | Define cómo hacerlo y lo lleva a cabo                |
| **Responsables**      | Alta dirección, Junta Directiva, CEO (Gerente de IT), Comité de TI  | Gerentes, Jefes de TI, personal operativo            |
| **Objetivo**          | Alinear TI con el negocio, mitigar riesgos, asegurar beneficios     | Entregar y mantener servicios de calidad             |
| **Ejemplo**           | Decidir si se terceriza infraestructura (si se pasa todo a la nube) | Implementar y mantener la infraestructura en la nube |
